    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='harvester_admins', to='auth.group')),
                ('user_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='harvester_users', to='auth.group')),
            ],
        ),
        migrations.CreateModel(
            name='MonitoredPath',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.SmallIntegerField(choices=[(-1, 'Import Failed'), (0, 'Unstable'), (1, 'Growing'), (2, 'Stable'), (3, 'Importing'), (4, 'Imported')], default=0)),
